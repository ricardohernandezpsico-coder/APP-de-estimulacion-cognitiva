...
- Kotlin NO compilado acá. Para verlo sin esperar a ganar 250 trofeos: en un build de depuración, sumar trofeos a mano no existe todavía; lo más rápido es jugar partidas con puntaje alto en un juego nuevo (Bronce → Plata a los 250: ~10-17 partidas buenas).
